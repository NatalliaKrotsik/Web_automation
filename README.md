...
## Framework Setup on local machine
    1. Clone the web-autotests repository:
        git clone <repository url>
    2. If your Git host uses OAuth-based credentials (e.g. self-hosted GitLab), configure it per your host's
       own instructions — this step is host-specific and not required for GitHub.
...
(link to your internal database connection documentation)
