...
VALID_EMAILS = [
    pytest.param("alina.petrova@gmail.com", id="valid_email_with_dot"),
    pytest.param("alina_petrova@gmail.com", id="valid_email_with_underscore"),
    pytest.param("alina-petrova@gmail.com", id="valid_email_with_hyphen"),
    pytest.param("prettyExample@box.com", id="valid_email_com_domain"),
    pytest.param("prettyExample@box.by", id="valid_email_by_domain"),
    pytest.param("prettyExample@box.ru", id="valid_email_ru_domain"),
    pytest.param("prettyExample@box.LOL", id="valid_email_uppercase_tld"),
    ...
    pytest.param("PRETTYEXAMPLE@BOX.COM", id="valid_email_uppercase"),
    pytest.param("prettyexample@box.com", id="valid_email_lowercase"),
    pytest.param("pRettyExaMple@box.com", id="valid_email_mixcase"),
]
    ...
    pytest.param(
        {
            ...
            "expected_error": "ivalid data (88 characters)",
        },
        id="Must be between 6 and 55 characters",
    ),
]
