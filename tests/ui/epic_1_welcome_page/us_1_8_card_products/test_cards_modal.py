...
class _CardModalBase:
    """Shared Allure hierarchy for cards modal test classes."""


@allure.story("Modal close behaviour")
class TestCardsModalClose(_CardModalBase):

    @allure.title("LP-222 — Modal closes when X button is clicked")
    ...
    @allure.title("LP-363 — Modal closes when Cancel button is clicked")
...
@allure.story("Modal content")
class TestCardsModalContent(_CardModalBase):

    @allure.title("LP-342 — Card application modal displays correct content")
...
@allure.story("Modal redirects")
class TestCardsModalRedirects(_CardModalBase):

    @allure.title("LP-349 — Modal redirects to login page when 'Existing profile' is clicked")
    ...
    @allure.title("LP-364 — Modal redirects to sign-up page when 'New profile' is clicked")
    @pytest.mark.qase("LP-364")
    @allure.severity(allure.severity_level.NORMAL)
