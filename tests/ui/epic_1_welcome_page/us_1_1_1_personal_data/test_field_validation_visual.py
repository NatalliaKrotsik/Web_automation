...
@allure.story("Field validation visual")
class TestFieldValidationVisual(_PersonalInfoBase):
    ...
    @allure.title("TC-04a — Required field messages shown on empty submit")
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.skip(reason="Not implemented yet")
