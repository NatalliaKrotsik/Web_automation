...
@pytest.mark.skip(
    ...
    "(example@gmail.com) exists and is reserved for OTP verification (US-1.1.4)."
)
...
class TestGenerateTemporaryPassword(_GenerateTemporaryPassword):
    ...
    def _setup(self):
        ...
        dynamic_email = f"john.doe_{unique_id}@gmail.com"
    ...
    @pytest.mark.skip(
        ...
        "Only one shared test Gmail account available (example@gmail.com) and email access "
...
@pytest.mark.skip(
    ...
    "Email access is not available — only one shared test Gmail account (example@gmail.com) exists "
