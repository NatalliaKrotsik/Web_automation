...
Guidance for Claude Code when working in the PRetty test automation framework.

## Project Overview

UI + API + DB test automation framework for **PrettyBank** — an internal banking web application.
