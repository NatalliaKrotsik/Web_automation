...
class OtpEmailClient:
    """Gmail IMAP client for retrieving OTP codes from pretty.aqa@gmail.com."""

    IMAP_SERVER = "imap.gmail.com"
    IMAP_PORT = 993

    def __init__(self, gmail_user: str = None, app_password: str = None):
        self.gmail_user = gmail_user or os.environ.get("AQA_GMAIL_ADDRESS", "pretty.aqa@gmail.com")
